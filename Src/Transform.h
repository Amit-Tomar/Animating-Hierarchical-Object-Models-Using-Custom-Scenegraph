...
// @TBD Single timer - Eclipse - Planet positions relative
// Seperate animation
// Chandrayan Trajectory
// Intensity of planet/moon bnased on sun
// Different viewpoints of the solar system

using namespace std;

class Transform:  public QObject, public Node
{
    Q_OBJECT
